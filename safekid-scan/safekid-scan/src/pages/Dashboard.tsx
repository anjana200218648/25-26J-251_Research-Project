...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch(`${AUTH_API_URL}/api/statistics?user_id=${currentUser._id}`, {
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/60 to-sky-50">
      ...
      <main className="w-full px-10 py-14 sm:px-12 md:px-16 lg:px-14 xl:px-16">
        ...
        <div className="mb-12 text-center">
          <div className="overflow-visible">
            <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-blue-600 via-sky-600 to-indigo-600 bg-clip-text text-transparent mb-4 pb-2" style={{ lineHeight: '1.3' }}>
              {td.welcomeBack || 'Welcome back,'} {user?.name}!
            </h1>
          </div>
          <p className="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
            {td.subtitle || "Monitor and protect your children's social media safety with our comprehensive platform"}
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/60">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-sm font-semibold text-gray-700">
                  {td.totalComplaints || 'Total Complaints'}
                </CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500">{td.submittedReports || 'Submitted reports'}</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/60">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-sm font-semibold text-gray-700">
                  {td.highRiskCases || 'High Risk Cases'}
                </CardTitle>
                <div className="p-2 bg-blue-100 rounded-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500">{td.requireAttention || 'Require attention'}</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/60">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                <CardTitle className="text-sm font-semibold text-gray-700">
                  {td.childrenRegistered || 'Children Registered'}
                </CardTitle>
                <div className="p-2 bg-blue-100 rounded-lg">
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-500">{td.underMonitoring || 'Under monitoring'}</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 text-white overflow-hidden relative h-full flex flex-col">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardTitle className="text-2xl font-bold mb-2">{td.contentScanner || 'Child Safety Content Scanner'}</CardTitle>
                <CardDescription className="text-blue-100 text-base">
                  {td.contentScannerDesc || 'Securely analyze and report risky or harmful social media content related to your child.'}
                </CardDescription>
              </CardHeader>
              <CardContent className="relative z-10 mt-auto">
                ...
                >
                  {td.submitContent || 'Submit Content'}
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-sky-500 via-blue-500 to-indigo-600 text-white overflow-hidden relative h-full flex flex-col">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardTitle className="text-2xl font-bold mb-2">{td.manageChildren || 'Manage Children'}</CardTitle>
                <CardDescription className="text-blue-100 text-base">
                  {td.manageChildrenDesc || "Add or edit your children's information and profiles for better monitoring"}
                </CardDescription>
              </CardHeader>
              <CardContent className="relative z-10 mt-auto">
                <Button
                ...
                >
                  {td.manageProfile || 'Manage Profile'}
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="mb-12">
          <h2 className="text-4xl font-extrabold bg-gradient-to-r from-blue-600 via-sky-600 to-indigo-600 bg-clip-text text-transparent mb-8">{td.safetyGuides || 'Safety Guides'}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/40 group">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900 mb-2">{td.socialMediaSafetyGuide || 'Social Media Safety Guide'}</CardTitle>
                <CardDescription className="text-gray-600 leading-relaxed">
                  {td.socialMediaSafetyGuideDesc || 'Learn how to protect your children from online threats, cyberbullying, and digital dangers'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button 
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/40 group">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900 mb-2">{td.parentTeacher || 'Parent-Teacher Communication'}</CardTitle>
                <CardDescription className="text-gray-600 leading-relaxed">
                  {td.parentTeacherDesc || "Best practices for discussing online safety with your child's school and educators"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button 
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50/40 group">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900 mb-2">{td.digitalLiteracy || 'Digital Literacy Tips'}</CardTitle>
                <CardDescription className="text-gray-600 leading-relaxed">
                  {td.digitalLiteracyDesc || 'Age-appropriate guidelines for different social media platforms and digital citizenship'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button 
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-3">
                  {td.stayInformed || 'Stay Informed'}
                </h3>
                <p className="text-blue-100 text-lg leading-relaxed mb-4">
                  {td.stayInformedDesc || 'Check your recent activities and stay updated with the latest safety recommendations for your children.'}
                </p>
                <Button
                  variant="secondary"
                ...
                >
                  {td.viewRecentActivity || 'View Recent Activity'}
                </Button>
              </div>
            </div>
          </CardContent>
