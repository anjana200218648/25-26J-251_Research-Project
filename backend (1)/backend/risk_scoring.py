...
def calculate_risk_score(
    ...
    school_patterns = [
        ...
        r'\bschool\s+performance\b.*\b(?:dropped?|declin(?:ing|ed?)|decreased?|reduced?|worse(?:ned)?|deteriorated?|lower(?:ed)?|poor|bad)\b',
        r'\bperformance\b.*\b(?:dropped?|decreased?|declined?|reduced?|worse(?:ned)?|deteriorated?|lower(?:ed)?)\b',
        ...
        r'\bdistracted\b.*\b(?:study|studying|studies|school|class|homework)\b',
        r'\b(?:study|studying|school|class|homework)\b.*\bdistracted\b',
        r'\b(?:concentration|focus|attention)\s+(?:problem|issue|difficulty)\b',
        r'\black\s+of\s+(?:concentration|focus|attention)\b',
        ...
        # Ignoring schoolwork / homework
        r'\bignor(?:e|es|ing|ed)\b.*\b(?:schoolwork|school\s+work|homework|studies|classes?|lessons?)\b',
        r'\b(?:schoolwork|school\s+work)\b.*\b(?:ignor(?:e|es|ing|ed)|neglect(?:ed|ing|s)?|not\s+doing|skip(?:ped|ping|s)?)\b',
    ]
    ...
    addiction_patterns = [
        ...
        # Withdrawal-like reaction when usage is restricted
        r'\b(?:upset|angry|furious|freak(?:s)?\s+out|meltdown|tantrum|rage|cries?|yells?|screams?|agitat(?:ed|ion)|distressed?)\b.*\b(?:limit|restrict|reduce|take\s+away|taken|remov(?:e|ed)|stop|cut|ban|block|control)\b',
        r'\b(?:limit|restrict|reduce|take\s+away|taken|remov(?:e|ed)|stop|cut|ban|block|control)\b.*\b(?:upset|angry|furious|freak(?:s)?\s+out|meltdown|tantrum|rage|cries?|yells?|screams?|agitat(?:ed|ion)|distressed?)\b',
        r'\b(?:try|tries|tried|attempt(?:ed|ing)?|want(?:ed|ing)?|set|enforce|put)\b.*\b(?:limit|restrict|rules?|boundary|boundaries|control)\b.*\b(?:upset|angry|furious|resist|refuse|fight|argue|yell|scream|tantrum|meltdown|agitat)\b',
    ]
    ...
    content_patterns = [
        r'\buploading\b',
        r'\bposting\s+(?:videos?|conten t|pictures?|photos?|reels?|stories?)\b',
        r'\bgoing\s+live\b',
