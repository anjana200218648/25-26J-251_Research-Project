    ...
    def load_model(self):
        ...
        try:
            ...
            if os.path.exists(metadata_path):
                ...
                print("[INFO] Loaded metadata and normalization parameters")
            else:
                metadata = {}
                print("[INFO] No metadata found, using defaults")
            ...
            if not selected_model_path:
                print("[WARNING] No trained model file found. Using untrained model.")
            else:
                print(f"[INFO] Using model file: {os.path.basename(selected_model_path)}")
            ...
            if encoders_path and os.path.exists(encoders_path):
                ...
                print(f"[INFO] Loaded encoders: {list(self.encoders.keys())}")
            else:
                print("[WARNING] No encoders found, creating defaults")
