    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            voice_complaint = VoiceComplaint(
                ...
                voice_confidence=1.0,  # Authenticated voice has high confidence
            ...
            print(f"[INFO] Voice complaint saved to PostgreSQL — ID: {voice_complaint.id}, "
                  f"risk: {risk_level}, score: {risk_score_result['total_score']}")
